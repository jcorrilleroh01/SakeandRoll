...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2025 a las 11:52:02
...
INSERT INTO `canjeos` (`IdCanje`, `IdUsuario`, `IdOferta`, `IdPlato`, `fecha_canjeo`, `Descuento`, `Estado`) VALUES
(77, 18, 11, 23, '20/5/2025', '100%', 'Completado');
...
(148, 6, '2025-05-21', 18, '', 'Recoger', 'Entregado');
...
(18, 'jaimech9', '$2y$10$reszo2wQWIT70q.PeT5ApOlE9Rph8d6vnxaPDSLoVaPt96vGr9Jqm', 'Jaime Perez Castillo', 'jaime@email.com', 929999999, 'calle 2 nº3'),
(19, 'jaimech92', '$2y$10$Q9mNZfqHyJXLYa8Els1VCOycPpk.2xu9wlRxm9AB8G7wsLDIObgeO', 'Jaime Fuentes', 'jaime2@email.com', 3333333, 'calle 2 nº3');
...
--
ALTER TABLE `canjeos`
  MODIFY `IdCanje` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT de la tabla `detallepedido`
--
ALTER TABLE `detallepedido`
  MODIFY `Iddetalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=273;

--
-- AUTO_INCREMENT de la tabla `logins`
--
ALTER TABLE `logins`
  MODIFY `idlogin` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=811;
...
--
ALTER TABLE `pedidos`
  MODIFY `Idpedido` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;
